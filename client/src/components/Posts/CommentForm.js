...
const CommentForm = () => {
  ...
  return (
    ...
    <Flex onSubmit={handleSubmit} as='form' p={2} alignItems='center'>
      <FormControl>
        <Textarea rows={1} ref={textareaRef} onChange={resizeTextarea} aria-label='Add a comment' fontSize={14} border='none' placeholder='Add a comment...' name='comment' _focusVisible={{ border: 'none' }} resize='none' height={textareaHeight} />
      </FormControl>
